...
namespace GameResources
{
    public class ResourceView : MonoBehaviour
    {
        ...
        [SerializeField] private bool _useShowHide;

        [Header("Animation Tweaks"), SerializeField] private float _countChangeDuration = 0.5f;
        [SerializeField] private float _punchScale = 0.1f;
        [SerializeField] private float _punchDuration = 0.2f;
        [SerializeField] private Color _punchColor = Color.white;
        ...
        private void ValueChanged(ResourceType resourceType)
        {
            ...
            DOVirtual.Int(
                _previousValue,
                _storage.GetResource(_type),
                _countChangeDuration,
                value => _amount.SetText("{0}", value)
            );
