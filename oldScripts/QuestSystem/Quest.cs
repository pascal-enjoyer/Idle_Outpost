...
namespace QuestSystem
{
    ...
    {
        [SerializeField] protected TopQuestArrow TopQuestArrow;
        [SerializeField] private Transform _target;
        [SerializeField] private float _showCameraDuration = 1.5f;
        [SerializeField] private bool _useTopArrow = true;
        [SerializeField] private bool _useHeroArrow = true;
