...
{
    [SerializeField] private GameTrigger _trigger;
    [SerializeField] private GameObject _toEnable;
    [SerializeField] private bool _scaleOnlyByHeight;
    ...
    private void Unlock()
    {
        ...
        _toEnable.transform.localScale = _scaleOnlyByHeight
            ? new Vector3(targetScale.x, 0f, targetScale.z)
            : Vector3.zero;
    ...
    private void Activate(Vector3 targetScale)
    {
        ...
        _toEnable.transform.DoPopUp(targetScale: targetScale, duration: _animationTime);
    }
}