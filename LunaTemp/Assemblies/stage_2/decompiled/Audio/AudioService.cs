...
namespace Audio
{
	public class AudioService : MonoBehaviour, IAudioService
	{
		...
		[SerializeField]
		private AudioEffect _audioEffectPrefab;

		public static AudioService Instance;

		private readonly HashSet<AudioEffect> _playingSounds = new HashSet<AudioEffect>();
		...
		{
			AudioEffect effect = Object.Instantiate(_audioEffectPrefab, base.transform);
