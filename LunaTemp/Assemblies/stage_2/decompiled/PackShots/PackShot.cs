...
namespace PackShots
{
	public class PackShot : MonoBehaviour
	{
		...
		public void Show()
		{
			...
			DOTween.Sequence().Append(_title.transform.DOMove(startPos + 3f * Vector3.down, 5f)).Append(_title.transform.DOMove(startPos, 5f))
				.SetEase(Ease.InOutSine)
				.SetLoops(-1, LoopType.Yoyo);
			_playButton.transform.DOScale(1.1f, 0.5f).SetEase(Ease.InOutSine).SetLoops(-1, LoopType.Yoyo);
		}
