...
namespace Extensions
{
	public static class VectorExtensions
	{
		...
		{
			return Vector3.Lerp(from, to, Random.Range(0f, 1f));
		}
		...
		public static bool IsOnScreen(this Vector3 pos, Camera camera, Vector2 offset = default(Vector2))
		{
			Vector3 screenPos = camera.WorldToViewportPoint(pos);
			return screenPos.x + offset.x >= 0f && screenPos.x - offset.x <= 1f && screenPos.y + offset.y >= 0f && screenPos.y - offset.y <= 1f;
		}
